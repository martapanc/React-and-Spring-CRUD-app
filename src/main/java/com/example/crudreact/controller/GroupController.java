...
import com.example.crudreact.model.User;
import com.example.crudreact.model.UserRepository;
...
public class GroupController {
    ...
    public ResponseEntity<Group> updateGroup(@Valid @RequestBody Group group, @PathVariable Long id) {
        ...
        if (g.isPresent()) {
            ...
            result.setAddress(group.getAddress());
            result.setCity(group.getCity());
            result.setCountry(group.getCountry());
            result.setPostalCode(group.getPostalCode());
            result.setState(group.getState());
            result.setEvents(group.getEvents());
